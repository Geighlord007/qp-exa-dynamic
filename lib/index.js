 ...
 * The bracket forms mirror the command's `input.hint` template.
 */
const EXA_USAGE = "on, off, status, results [<n>], type [<type>]";
	...
	ctx.inject(["commands"], (commandCtx) => {
		try {
			commandCtx.commands.register({
				name: COMMAND_NAME,
				description: "Show or toggle Exa Dynamic Highlights, or set the search type",
				input: { hint: "[on|off|status|type <type>]" },
